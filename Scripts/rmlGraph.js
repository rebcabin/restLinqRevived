...
Canvas.prototype.Draw = function () {
    ...
    // bbeckman: 6 Nov 12 -- moving this code below the code for drawing the path
    ...
    debugText.innerHTML =
            " total: " + this.drawSet.length +
            " visible: " + this.visible.length +
            " pictured: " + this.pictures.length + c +
            " energy: " + RML.viewMoveEnergy;
