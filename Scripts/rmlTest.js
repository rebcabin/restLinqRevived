...
var categoryFilter = '.Where(function(entity) {return entity !== undefined && entity.Category !== undefined;})';
var socket = null;
function Test() 
{    
    //socket = new WebSocket('ws://eladg-dev:80');
    ...
    socket.onopen = function () {
        ...
        locationMockObservable
            ...
            // This is the client-side proxy of the observer to the locationMock.
